...
pd -rt -jack -channels 2 -nogui -send "id orgel02" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel03" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel04" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel05" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel06" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel07" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel08" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel09" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -channels 2 -nogui -send "id orgel10" $DIR/orgelmodul-dsp-osc.pd &
