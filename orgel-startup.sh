...
# pd -rt -jack -audiobuf 0 -blocksize 32 -channels 10 -send "id orgel04" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -blocksize 32 -channels 10 -send "id orgel05" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -blocksize 32 -channels 10 -send "id orgel06" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -blocksize 32 -channels 10 -send "id orgel07" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -audiobuf 0 -blocksize 32 -channels 10 -send "id orgel08" $DIR/orgelmodul-dsp-osc.pd &
