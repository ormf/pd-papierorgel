...
pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel01" $DIR/orgelmodul-dsp-osc.pd &
pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel02" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel03" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel04" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel05" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel06" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel07" $DIR/orgelmodul-dsp-osc.pd &
# pd -rt -jack -audiobuf 0 -channels 10 -send "id orgel08" $DIR/orgelmodul-dsp-osc.pd &
